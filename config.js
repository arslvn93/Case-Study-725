const config = {
  "globals": {
    "agents": [
      {
        "name": "Daniel Losier",
        "imageSrc": "https://salesgenius.s3.ca-central-1.amazonaws.com/uploads/upload-Dan-Losier.jpg",
        "contactDetails": [
          {
            "type": "email",
            "value": "daniel@erbaandco.com"
          },
          {
            "type": "phone",
            "value": "4164186470"
  ...
  "sections": [
    ...
    },
    {
      ...
      "title": "The Solution",
      "paragraphs": [
        "I'd already earned their trust. I represented the sellers when they originally purchased the property, and throughout their renovation journey, they leaned on me for insight and advice. They watched how I operated—honest, knowledgeable, and genuinely invested in their success. When the project neared completion and the market looked scariest, they didn't interview other agents. They called me because they knew I'd fight for them when it mattered most."
      ],
      "image": {
    ...
    },
    {
      ...
      "ctaBannerContent": {
        ...
        "headline": "Schedule Your Confidential Property Strategy Session—Discover Exactly What Your Home Could Sell For (Even in This Market)",
